    ...
    columns: [
      ...
      },
      {
        ...
        render: (text, row, index) => {
          return (
            <>
              <Button type="primary" onClick={() => this.editItem(row)}>编辑</Button>
              <span>&emsp;</span>
              <Button type="primary" onClick={() => this.editItemModal(index)}>此页编辑</Button>
              <span>&emsp;</span>
      ...
      <PageHeaderWrapper title={false}>
        <Card className="page__list">
          ...
          <div className="operator-bar">
            <Button onClick={this.addItem}>发布文章</Button>
